(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function initializePlaylists(config, genre) {
            ...
            const aggregatedPlaylistConfig = config.AggregatedPlaylistConfigs[aggregatedPlaylistConfigKey];
            ...
            if (aggregatedPlaylistConfig) {
                ...
                fetchAndDisplayData('Aggregated Playlist', placeholderId, aggregatedPlaylistConfig.ReadPath);
            }
        }
        ...
        // Fetch and display the aggregated playlist on page load
        fetch('./config.json') // assuming your JSON file is named config.json
            .then(response => response.json())
            .then(config => {
