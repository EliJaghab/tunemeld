...
function RankBadge({ rank }: RankBadgeProps) {
  ...
  return (
    <span
      className={clsx(
        "absolute -top-1 -right-1 desktop:-top-[7px] desktop:-right-[7px]",
        "flex items-center justify-center",
        "text-white font-bold text-[9px] desktop:text-[11px] leading-none",
        "z-10 rounded-full bg-badge-red",
        "shadow-[0_1px_3px_rgba(0,0,0,0.3)] px-0.5",
        isDoubleDigit
          ? [
              "min-w-[14px] w-[18px] h-[14px]",
              `desktop:min-w-[18px] desktop:w-[22px] desktop:h-[18px]
    ...
    <div className={clsx("relative inline-block")}>
      ...
      >
        <img
          ...
          className={clsx("w-6 h-6 desktop:w-[30px] desktop:h-[30px]")}
        />
      </a>
