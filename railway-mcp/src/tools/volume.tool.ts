...
export const volumeTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Viewing persistent storage configurations", "Managing data volumes", "Auditing storage usage"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Setting up database storage", "Configuring persistent data", "Adding file storage"],
      notFor: ["Temporary storage needs", "Static file hosting", "Memory caching"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Removing unused storage", "Storage cleanup", "Resource management"],
      notFor: ["Temporary data removal", "Data backup (use volume_backup first)"],
      relations: {
