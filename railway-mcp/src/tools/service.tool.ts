...
export const serviceTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Getting an overview of a project's services", "Finding service IDs", "Checking service status"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Viewing service configuration and status", "Checking deployment details", "Monitoring service health"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Custom database deployments", "Pre-built container deployments", "Specific version requirements"],
      notFor: [
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Changing service settings", "Updating resource limits", "Modifying deployment configuration"],
      notFor: [
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Removing unused services", "Cleaning up test services", "Project reorganization"],
      notFor: [
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Applying configuration changes", "Clearing service state", "Resolving runtime issues"],
      notFor: [
    ...
    }),
    {
      ...
      environmentId: z
        .string()
        .describe("ID of the environment where the service should be restarted (usually obtained from service_info)"),
    },
