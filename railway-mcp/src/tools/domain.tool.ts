...
export const domainTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Viewing service endpoints", "Managing domain configurations", "Auditing domain settings"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Setting up custom domains", "Configuring service endpoints", "Adding HTTPS endpoints"],
      notFor: ["TCP proxy setup (use tcp_proxy_create)", "Internal service communication"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Validating domain availability", "Pre-deployment checks", "Domain planning"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Changing target ports", "Updating domain settings", "Reconfiguring endpoints"],
      notFor: ["Changing domain names (delete and recreate instead)", "TCP proxy configuration"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Removing unused domains", "Cleaning up configurations", "Domain management"],
      notFor: ["Temporary domain disabling", "Port updates (use domain_update)"],
      relations: {
        prerequisites: ["domain_list"],
