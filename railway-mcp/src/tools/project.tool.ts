...
export const projectTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Getting an overview of all projects", "Finding project IDs", "Project discovery and management"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Starting new applications", "Setting up development environments", "Creating project spaces"],
      notFor: ["Duplicating existing projects"],
      relations: {
        nextSteps: ["service_create_from_repo", "service_create_from_image", "database_deploy"],
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      notFor: ["Temporary project deactivation", "Service-level cleanup (use service_delete)"],
      relations: {
