...
export const templateTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Discovering available templates", "Planning service deployments", "Finding template IDs and sources"],
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Starting new services from templates", "Quick service deployment", "Using pre-configured templates"],
      notFor: ["Custom service configurations", "GitHub repository deployments (use service_create_from_repo)"],
      relations: {
    ...
    }),
    {
      ...
      teamId: z
        .string()
        .optional()
        .describe("ID of the team to create the service in (if not provided, will use the default team)"),
    },
    async ({
      projectId,
      templateId,
