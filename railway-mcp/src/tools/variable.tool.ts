...
export const variableTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Viewing service configuration", "Auditing environment variables", "Checking connection strings"],
      relations: {
    ...
    }),
    {
      ...
      environmentId: z
        .string()
        .describe("ID of the environment to list variables from (usually obtained from service_list)"),
      serviceId: z
        .string()
        .optional()
        .describe(
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Setting configuration values", "Updating connection strings", "Managing service secrets"],
      notFor: ["Bulk variable updates (use variable_bulk_set)", "Temporary configuration changes"],
      relations: {
        prerequisites: ["service_list"],
    ...
    }),
    {
      ...
      serviceId: z
        .string()
        .optional()
        .describe("Optional: ID of the service for the variable, if omitted creates/updates a shared variable"),
    },
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Removing unused configuration", "Security cleanup", "Configuration management"],
    ...
    }),
    {
      ...
      environmentId: z
        .string()
        .describe("ID of the environment to delete the variable from (usually obtained from service_list)"),
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Migrating configuration between services", "Initial service setup", "Bulk configuration updates"],
      notFor: ["Single variable updates (use variable_set)", "Temporary configuration changes"],
      relations: {
        prerequisites: ["service_list"],
        nextSteps: ["deployment_trigger", "service_restart"],
    ...
    }),
    {
      ...
      environmentId: z
        .string()
        .describe("ID of the environment for the variables (usually obtained from service_list)"),
      variables: z.record(z.string()).describe("Object mapping variable names to values"),
      serviceId: z
        .string()
        .optional()
        .describe("Optional: ID of the service for the variables, if omitted updates shared variables)"),
    },
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Environment migration", "Configuration sharing", "Environment duplication"],
      notFor: ["Single variable updates (use variable_set)", "Temporary configuration changes"],
      relations: {
        prerequisites: ["service_list"],
        nextSteps: ["deployment_trigger", "service_restart"],
    ...
    }),
    {
      ...
      overwrite: z
        ...
        .optional()
        .default(false)
        .describe("Whether to overwrite existing variables in the target environment"),
    },
