...
export const tcpProxyTools = [
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Viewing TCP proxy configurations", "Managing external access", "Auditing service endpoints"],
      relations: {
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Setting up database access", "Configuring external connections", "Exposing TCP services"],
      notFor: ["HTTP/HTTPS endpoints (use domain_create)", "Internal service communication"],
      relations: {
        prerequisites: ["service_list"],
  ...
  createTool(
    ...
    formatToolDescription({
      ...
      bestFor: ["Removing unused proxies", "Security management", "Endpoint cleanup"],
