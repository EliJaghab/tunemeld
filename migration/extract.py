...
EXTRACT_BASE_PATH = "migration/data/extract"
...
def format_filename(service_name, playlist_key):
    ...
    base_name = f"{service_name}_{playlist_key.replace('playlist_key', '')}extract".lower()
...
if __name__ == "__main__":
    ...
    for service_name, config in SERVICE_CONFIGS.items():
        for genre in PLAYLIST_GENRES:
            ...
            print(f"retrieving {genre} from {service_name} with credential {playlist_key}")
