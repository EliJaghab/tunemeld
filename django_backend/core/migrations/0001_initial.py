# Generated by Django 4.2 on 2025-08-30 16:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isrc', models.CharField(blank=True, db_index=True, help_text='International Standard Recording Code (12 characters)', max_length=12, null=True, validators=[django.core.validators.RegexValidator('^[A-Z]{2}[A-Z0-9]{3}[0-9]{7}$', 'Invalid ISRC format')])),
            ],
            options={
                'db_table': 'playlists',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_url', models.CharField(default='', help_text='URL to service icon image', max_length=200)),
            ],
            options={
                'db_table': 'services',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isrc', models.CharField(help_text='International Standard Recording Code (12 characters)', max_length=12, validators=[django.core.validators.RegexValidator('^[A-Z]{2}[A-Z0-9]{3}[0-9]{7}$', 'Invalid ISRC format')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('youtube_url', models.URLField(blank=True, help_text='YouTube track URL', null=True)),
                ('soundcloud_url', models.URLField(blank=True, help_text='SoundCloud track URL', null=True)),
                ('album_cover_url', models.URLField(blank=True, help_text='Album cover image URL', null=True)),
                ('aggregate_rank', models.IntegerField(blank=True, help_text='Cross-service aggregate ranking', null=True)),
                ('aggregate_score', models.FloatField(blank=True, help_text='Cross-service aggregate score', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='servicetrack',
            name='track',
            field=models.ForeignKey(blank=True, help_text='Reference to consolidated Track record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='service_tracks', to='core.track'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='playlist',
            name='service_track',
            field=models.ForeignKey(help_text='Reference to the normalized service track record', on_delete=django.db.models.deletion.CASCADE, related_name='playlists', to='core.servicetrack'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='servicetrack',
            index=models.Index(fields=['track_name', 'artist_name'], name='service_tra_track_n_45500e_idx'),
        ),
        migrations.AddIndex(
            model_name='servicetrack',
