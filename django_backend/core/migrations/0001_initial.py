    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "display_name",
                    models.CharField(help_text="Human-readable genre name", max_length=100),
                ),
            ],
            options={
                "db_table": "genres",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "display_name",
                    models.CharField(help_text="Human-readable service name", max_length=100),
                ),
                (
                    "icon_url",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "album_name",
                    models.CharField(blank=True, help_text="Album name", max_length=500, null=True),
                ),
                (
                    "spotify_url",
                    models.URLField(blank=True, help_text="Spotify track URL", null=True),
                ),
                (
                    "apple_music_url",
                    models.URLField(blank=True, help_text="Apple Music track URL", null=True),
                ),
                (
                    "youtube_url",
                    models.URLField(blank=True, help_text="YouTube track URL", null=True),
                ),
                (
                    "soundcloud_url",
                    models.URLField(blank=True, help_text="SoundCloud track URL", null=True),
                ),
                (
                    "album_cover_url",
                    models.URLField(blank=True, help_text="Album cover image URL", null=True),
                ),
                (
                    "aggregate_rank",
                    models.IntegerField(
                ...
                (
                    "aggregate_score",
                    models.FloatField(blank=True, help_text="Cross-service aggregate score", null=True),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["artist_name"], name="tracks_artist__0a8ef7_idx"),
                    models.Index(fields=["etl_run_id"], name="tracks_etl_run_5e76c3_idx"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "genre",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="core.genre"),
                ),
                (
                    "service",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "playlist_name",
                    models.CharField(blank=True, help_text="Playlist display name", max_length=255),
                ),
                (
                    "playlist_cover_url",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "view_count",
                    models.BigIntegerField(help_text="View count at this point in time"),
                ),
                (
                    "delta_count",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["service"], name="view_counts_service_3e4aa6_idx"),
                    models.Index(fields=["last_updated"], name="view_counts_last_up_0540eb_idx"),
                    models.Index(fields=["view_count"], name="view_counts_view_co_2e64d3_idx"),
                ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["service", "genre"], name="service_tra_service_96adaf_idx"),
        ),
        migrations.AddIndex(
            model_name="servicetrack",
        ...
        migrations.AddIndex(
            model_name="servicetrack",
            index=models.Index(fields=["service", "isrc"], name="service_tra_service_64f0ba_idx"),
        ),
        migrations.AddIndex(
            model_name="servicetrack",
            index=models.Index(fields=["etl_run_id"], name="service_tra_etl_run_2f6d81_idx"),
        ),
        ...
        migrations.AddIndex(
            model_name="rawplaylistdata",
            index=models.Index(fields=["etl_run_id"], name="raw_playlis_etl_run_e3dc5a_idx"),
        ),
        migrations.AddIndex(
            model_name="playlist",
        ...
        migrations.AddIndex(
            model_name="playlist",
            index=models.Index(fields=["etl_run_id"], name="playlists_etl_run_a70eb6_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="playlist",
            unique_together={("service", "genre", "position", "etl_run_id")},
