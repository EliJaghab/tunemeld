...
@strawberry.type
class ButtonLabelType:
    button_type: str = strawberry.field(description="Type of button (e.g., 'source_icon', 'genre_button')")
    context: str | None = strawberry.field(description="Context identifier for the button", default=None)
    title: str | None = strawberry.field(description="Tooltip text for the button", default=None)
    aria_label: str | None = strawberry.field(description="Screen reader accessible label", default=None)

    def to_dict(self) -> dict:
        """Convert ButtonLabelType to dictionary for caching."""
        return {
